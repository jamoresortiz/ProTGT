...
var bodyStream = __webpack_require__(123);
var PassThrough = __webpack_require__(7).PassThrough;
var FetchError = __webpack_require__(50);
...
var fixer = __webpack_require__(150)
normalize.fixer = fixer

var makeWarning = __webpack_require__(163)
...
/* MIT license */
var cssKeywords = __webpack_require__(171);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _log.info)('For the source code, check out: https://github.com/zeit/now-cli');

            // Print an empty line
            console.log('');

            _context2.next = 13;
            return (0, _asyncRetry2.default)((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      url = 'https://github.com/zeit/now-cli/releases/download/' + packageJSON.version + '/' + name + '.gz';
                      _context.next = 7;
                      return (0, _nodeFetch2.default)(url, { compress: false });
          ...
          case 13:
            ...
            _fs2.default.writeFileSync(backup, _fs2.default.readFileSync(target));
    ...
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            if (!_fs2.default.existsSync(backup)) {
              _context3.next = 4;
              break;
            }

            _fs2.default.writeFileSync(target, _fs2.default.readFileSync(backup));
            _context3.next = 6;
            break;
          ...
          case 6:
            ...
            _fs2.default.writeFileSync(now, '');
            // Workaround for https://github.com/npm/cmd-shim/pull/25
            _context3.t0 = _path2.default;
            _context3.next = 12;
            return (0, _whichPromise2.default)('npm');

          case 12:
            _context3.t1 = _context3.sent;
            globalPath = _context3.t0.dirname.call(_context3.t0, _context3.t1);
            gitBashFile = _path2.default.join(globalPath, 'now');

            if (!_fs2.default.existsSync(gitBashFile)) {
              gitBashFile = _path2.default.join(process.env.APPDATA, 'npm/now');
            }

            _fs2.default.writeFileSync(gitBashFile, modifyGitBashFile(_fs2.default.readFileSync(gitBashFile, 'utf8')));
            _context3.next = 22;
            break;
...
var _child_process = __webpack_require__(97);

var _zlib = __webpack_require__(46);

var _zlib2 = _interopRequireDefault(_zlib);

var _death = __webpack_require__(98);
...
// Utilities
_nodeFetch2.default.Promise = _promise2.default;
...
var packageDir = _path2.default.join(__dirname, '..', '..');
var packageJSON = _readPkg2.default.sync(packageDir);
...
module.exports = {
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(115) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(28).concat(__webpack_require__(48)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(28).concat(__webpack_require__(48)) },
        gb18030: function() { return __webpack_require__(116) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(49).concat(__webpack_require__(118)) },
...
// Packages
var retrier = __webpack_require__(127);
...
var RetryOperation = __webpack_require__(129);
...
module.exports = __webpack_require__(30)(__webpack_require__(131), __webpack_require__(135));
...
var COLON = isWindows ? ';' : ':'
var isexe = __webpack_require__(132)
...
module.exports = global.Promise || __webpack_require__(136);
...
const loadJsonFile = __webpack_require__(138);
const pathType = __webpack_require__(149);
...
const stripBom = __webpack_require__(143);
const parseJson = __webpack_require__(144);
const pify = __webpack_require__(30);
...
var legacy = __webpack_require__(142)
var queue = []
...
if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
  process.on('exit', function() {
    debug(queue)
    __webpack_require__(52).equal(queue.length, 0)
  })
}

module.exports = patch(__webpack_require__(51))
...
var errorEx = __webpack_require__(145);
var fallback = __webpack_require__(147);
...
var util = __webpack_require__(13);
var isArrayish = __webpack_require__(146);
...
var Uni = __webpack_require__(148)
...
var validateLicense = __webpack_require__(152);
var hostedGitInfo = __webpack_require__(157)
var isBuiltinModule = __webpack_require__(159)
var depTypes = ["dependencies","devDependencies","optionalDependencies"]
var extractDescription = __webpack_require__(161)
var url = __webpack_require__(12)
var typos = __webpack_require__(162)
...
var correct = __webpack_require__(155);
...
var parser = __webpack_require__(154).parser
...
exports.main = function commonjsMain(args) {
    ...
    var source = __webpack_require__(3).readFileSync(__webpack_require__(11).normalize(args[1]), "utf8");
...
var licenseIDs = __webpack_require__(156);
...
var url = __webpack_require__(12)
var gitHosts = __webpack_require__(55)
var GitHost = module.exports = __webpack_require__(158)
...
var builtinModules = __webpack_require__(160);
...
var util = __webpack_require__(13)
var messages = __webpack_require__(164)
...
var _chalk = __webpack_require__(167);

var _chalk2 = _interopRequireDefault(_chalk);

var _progress = __webpack_require__(177);

var _progress2 = _interopRequireDefault(_progress);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var bar = void 0; // Packages
...
function warn(text) {
  console.log(_chalk2.default.red('> Warning!'), text);
}
...
const escapeStringRegexp = __webpack_require__(168);
const ansiStyles = __webpack_require__(169);
const supportsColor = __webpack_require__(173);
...
const colorConvert = __webpack_require__(170);
...
const os = __webpack_require__(174);
const hasFlag = __webpack_require__(175);
